...
public class InstructorPoly extends AcademicianPoly {

    private String lesson;

    public InstructorPoly(String name, String phoneNumber, String mail, String department, String title, String lesson) {
